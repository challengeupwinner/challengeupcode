# -*- coding: utf-8 -*-
"""
Created on Thu Aug 22 14:46:59 2019
...
#for every patient index


def segment(patients, path_to_data,path_to_results):
    ...
    for subject in patients:
        ...
        temp_path=path_to_results+os.sep+"Labels"+os.sep+subject
        if not os.path.exists(temp_path):
            os.mkdir(temp_path)
...
if __name__ == "__main__":
    ...
    path_to_data="Data"
    patients=[ "Subject_1", "Subject_3", "Subject_4", "Subject_7", "Subject_10", "Subject_11", "Subject_12", "Subject_13", "Subject_14"]
    segment(patients, path_to_data,path_to_results) # if started from cmd, script should be upgraded to get arguments
